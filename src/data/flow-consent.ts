// The one Flow waitlist consent sentence. Every Flow capture surface (home
// hero, /flow/ hero, the proof-nuggets form, the FlowWaitlist panels) records
// this verbatim so a subscriber's recorded consent reads the same no matter
