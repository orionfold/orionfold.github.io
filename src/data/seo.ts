...
export const SITE = {
  ...
  ogImageAlt:
    'Orionfold Flow: Conduct beautiful documents with AI agency built in. Orionfold Flow creates documents with self-improving intelligence built in and AI agency enabled to get work done.',
