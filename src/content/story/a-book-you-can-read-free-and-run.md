...
## Prose and code in lockstep

Here is what makes them different. The prose and the code move together. The book is not theory floating above the real work. Every claim has working code behind it, and that code runs.
...
A book is the first of the four levers, the playbook, taken all the way to the bottom. A short story like this one gives you the shape of an idea. A book you can run gives you the whole thing, step by step, with the code to prove it.

A playbook you cannot test is just an opinion. A playbook you can run is a tool. That is the bar I hold my [books](/books/) to.

The kit, the books, the models, these stories. I make all of it out in the open, on purpose. That is not an accident. It is the whole method, and it is the last story in this arc: [Building in public](/story/building-in-public/).
