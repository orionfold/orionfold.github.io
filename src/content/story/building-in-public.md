...
date: 2026-06-07
summary: Every story here, every number and honest miss, I put out in public on purpose. This is why I build in the open, and how you can help shape what comes next.
tags:
  - Building in public
  - Sponsorship
  - AI Native
hero: ../../assets/story/building-in-public/hero.jpeg
heroAlt: "Three-panel comic. A builder pins a card to a big public roadmap board with Shipped, Building now, and Planned lanes, a diverse community cheers and raises coins to vote, and a lane lights up Funded under a blue constellation. A banner reads: Build in public, vote with dollars."
---
...
That is the end of the arc, for now. Where you go next is up to you. Pick one of the four levers and pull it. Read a [book](/books/). Run the [open kit](/software/fieldkit/). Try a [custom model](/models/). Or back a lane on the roadmap and help steer it.

And if you are just arriving, you can start at the very beginning of the journey, the year the gap between paid and open AI began to close: [The year the gap closed](/story/the-year-the-gap-closed/).
