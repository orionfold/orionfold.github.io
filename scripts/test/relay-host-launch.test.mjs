...
assert.match(page, /Equivalent live receipts on providers beyond the tested DigitalOcean topology/, 'page must preserve the named-provider verification boundary');
